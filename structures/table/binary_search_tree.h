...
namespace structures
{
	...
	inline Structure& BinarySearchTree<K, T>::assign(Structure& other)
	{
		...
		if (this != &other)
		{
			...
			Iterator<TableItem<K, T>*>* iteratorCurrent = new Tree<TableItem<K, T>*>::PreOrderTreeIterator(otherBst.binaryTree_->getRoot());
			Iterator<TableItem<K, T>*>* iteratorEnd = new Tree<TableItem<K, T>*>::PreOrderTreeIterator(nullptr);
