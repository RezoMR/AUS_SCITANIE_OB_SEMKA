...
namespace structures
{
	...
	protected:
		...
		Array<KWayTreeNode<T, K>*>* potomok_;
	};
	...
	inline KWayTreeNode<T, K>::KWayTreeNode(T data) :
		TreeNode<T>(data),
		potomok_(new Array<KWayTreeNode<T, K>*>(K))
	{
	}
	...
	inline KWayTreeNode<T, K>::KWayTreeNode(KWayTreeNode<T, K>& other) :
		TreeNode<T>(other),
		potomok_(new Array<KWayTreeNode<T, K>*>(*other.potomok_))
	{
	}
	...
	{
		KWayTreeNode<T, K>* result = potomok_->at(order);
		potomok_->at(order) = dynamic_cast<KWayTreeNode<T, K>*>(son);
